...
import chap = require("../lib/chap");

describe("CHAP, MS-CHAPv1 and MS-CHAPv2 library for Node.js",() => {
  describe("CHAP methods",() => {

    it("ChallengeResponse method",() => {
  ...
  describe("MS-CHAPv1",() => {
    ...
    describe("MPPE",() => {
      ...
      it("GetKey method generating key 8 octets long",() => {
      ...
      it("GetKey method generating key 16 octets long",() => {
      ...
      it("40-bit Key Derivation without current key",() => {
      ...
      it("56-bit Key Derivation without current key",() => {
      ...
      it("128-bit Key Derivation without current key",() => {
  ...
  describe("MS-CHAPv2",() => {
    ...
    describe("MPPE",() => {
      ...
      it("GetNewKeyFromSHA method 8 octets long",() => {
      ...
      it("GetAsymmetricStartKey method 8 octets long",() => {
      ...
      it("GetNewKeyFromSHA method 16 octets long",() => {
      ...
      it("GetAsymmetricStartKey method 16 octets long",() => {
