...
declare module NodeJS {
    ...
    export interface EventEmitter {
        ...
        on<R extends EventEmitter>(event: string, listener: Function): R;
        once<R extends EventEmitter>(event: string, listener: Function): R;
        removeListener<R extends EventEmitter>(event: string, listener: Function): R;
        
        on<T1, R extends EventEmitter>(event: string, listener: (a: T1) => void): R;
        once<T1, R extends EventEmitter>(event: string, listener: (a: T1) => void): R;
        removeListener<T1, R extends EventEmitter>(event: string, listener: (a: T1) => void): R;
        removeAllListeners<R extends EventEmitter>(event?: string): R;
    }
