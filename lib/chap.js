...
(function (chap) {
    ...
    var MSCHAPv1 = (function () {
        ...
        MSCHAPv1.DesHash = function (key) {
            return this.DesEncrypt(new Buffer("KGS!@#$%", "ascii"), key);
        };
        MSCHAPv1.DesEncrypt = function (clear, key) {
        ...
        MSCHAPv1._ParityKey = function (key) {
    ...
    var MSCHAPv2 = (function () {
        ...
        MSCHAPv2.GenerateNTResponse = function (authChallenge, peerChallenge, username, password) {
            var passwordBuffer = new Buffer(password, "utf16le");
        ...
        MSCHAPv2.ChallengeHash = function (peerChallenge, authChallenge, username) {
        ...
        MSCHAPv2.ChallengeResponse = function (challenge, passwordHash) {
